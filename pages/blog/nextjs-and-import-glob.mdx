---
layout: 'PostLayout'
title: 'Bulk impport blog posts with next-mdx-enhanced and babel-plugin-import-glob-array` '
publishedOn: '2020-12-16'
authoredBy: 'Andrew Shannon'
authImg: '/static/images/author/me.jpg'
summary: 'Import all of your MDX pages into a single index in Next.js using next-mdx-enhanced and babel-plugin-import-glob-array.'
---
