...
function about() {
  return (
    <Layout>
      ...
      Hey, I'm Andrew. I grew up in a small town in Maine and graduated from Florida Atlantic University with a degree in management information systems.
      </Text>
      <Text m="15px 0" as="p">
      I enjoy creating, so I thought I wanted to be a front-end developer. I embarked on a multiyear journey to teach myself a modern front-end framework so that I could build websites like this spiffy blog you're reading now.
      </Text>
      <Text m="15px 0" as="p">
